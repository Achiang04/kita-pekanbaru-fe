...
export default function CoverTextInCenter({
  img,
  imgPortrait,
  shadow,
  content,
    ...
    <div className="cover-text-center">
      <div
        className={clsx(
          ...
          fixed && "cover-text-center__wrapper_fixed"
        )}
      >
        <div
        ...
        {showChevronDown && (
          <a href="#" className="cover-text-center__down" onClick={scrollDown}>
...
function CoverContent({ intro, head, subHead }: ICoverTextContent) {
  return (
    <>
      {intro && (
        <div
          className="cover-text-center__content-intro"
          dangerouslySetInnerHTML={{ __html: intro }}
        />
      )}
      {head && (
        <div
          className="cover-text-center__content-head"
          dangerouslySetInnerHTML={{ __html: head }}
        />
      )}
      {subHead && (
        <div
          className="cover-text-center__content-sub-header"
