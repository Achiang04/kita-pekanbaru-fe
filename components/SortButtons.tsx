      ...
      <ul className="sort-buttons__list list-unstyled">
        {sortFields.map((field) => {
          ...
          return (
            <li
              key={field.id}
              className={clsx("sort-buttons__element", isActive && "active")}
            >
                    ...
                    <FontAwesomeIcon
                      ...
                      icon={
                        order === TSortOrder.asc
                          ? (faSortAmountDownAlt as IconProp)
                          : (faSortAmountDown as IconProp)
                      }
                    />
                  )}
                </a>
...
const getActiveSortField = (sort: string) => {
  ...
  const activeId = (sortFields.find((el) => el.alias === sortAlias) ||
    sortFields.find((el) => el.alias === "default"))!.id;
