...
import SwiperSliderSlide, {
  ISwiperSliderSlide,
} from "./swiperSlider/SwiperSliderSlide";
  ...
  return (
    ...
    >
      ...
      >
        {slides.map((slide, i) => (
          <SwiperSlide
            className={clsx("swiper-slider__slide", slideClassName || "")}
            key={i}
          >
      ...
      {showPrevNext && (
        <>
          <a href="#" className="swiper-slider__prev">
            <FontAwesomeIcon icon={faChevronLeft as IconProp} />
          </a>
          <a href="#" className="swiper-slider__next">
